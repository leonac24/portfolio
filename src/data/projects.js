...
export const PROJECTS = [
  {
    ...
    image: '/rethread.png',
    gallery: [
      { src: '/gallery/rethread-demo.jpg', alt: 'Demoing Rethread to judges', cap: 'demoing to the judges ✦' },
      { src: '/gallery/rethread-closet.jpg', alt: 'Rethread closet dashboard showing a scanned garment and sustainability stats', cap: 'the closet dashboard ✦' },
      { src: '/gallery/rethread-team.jpg', alt: 'The Rethread team', cap: 'the team ✦' },
    ],
  ...
  },
  {
    ...
    cover: <FaGamepad />,
    image: '/pixel-truth.png',
    gallery: [
      { src: '/gallery/pixel-truth-gameplay.png', alt: 'Pixel Truth gameplay', cap: 'gameplay ✦' },
      { src: '/gallery/lahacks-team.png', alt: 'The Pixel Truth team at LA Hacks 2026', cap: 'the team @ LA Hacks 2026 ✦' },
    ],
